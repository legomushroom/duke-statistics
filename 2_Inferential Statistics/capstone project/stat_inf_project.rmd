...
compareTwoProportions = function(contingencyTable, i1, i2) {
  ...
  if (condition1 | condition2) {
    return(print("no # of observations condition is met"))
  }
  ...
  if ((CIlower > 0 & CIupper > 0) | (CIlower < 0 & CIupper < 0)) {
    cat("\n✔ Statisticly sighnificant difference in proportions: ", "we'd reject the null hypoothesis CI(", CIlower, ", ", CIupper, ")", sep = "" )
  } else {
    cat("\n⊗ Not a statisticly sighnificant difference in proportions: ", "we'd not reject the null hypoothesis CI(", CIlower, ", ", CIupper, ")", sep = "" )
  }
