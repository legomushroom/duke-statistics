...
<li> The sample distribution must be nearly normal. </li> <!-- This -->
</ol>
...
<ol>
<li> 95% of the time the true average area of houses in Ames, Iowa, will be in this interval. </li> <!-- This -->
<li> 95% of random samples of size 60 will yield confidence intervals that contain the true average area of houses in Ames, Iowa. </li> <!-- Or this -->
