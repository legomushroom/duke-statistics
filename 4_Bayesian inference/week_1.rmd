...
<ol>
<li> 0.3 </li>
<li> 0.4 </li> <!-- This (complement of the P(M1 is Good | Win on M1)) -->
<li> 0.5 </li>
<li> 0.6 </li>
<li> 0.7 </li>
</ol>
...
<ol>
<li> 0.3 </li>
<li> 0.4 </li> <!-- This (complemet of P(M1 is good | Win on M1)) -->
<li> 0.5 </li>
<li> 0.6 </li>
<li> 0.7 </li>
</ol>
...
<ol>
<li> 
  Posterior - $P(M_1 \text{ is Good} ~|~ \text{Win on } M_1)$ <br/> <!-- This -->
...
<li> $P(M_1\text{ is good}~|~\text{data}) = 0.571$, $P(M_2\text{ is good}~|~\text{data}) = 0.429$ </li> <!-- This -->
...
m2_p2 = data.frame(machine=c(2L), outcome=c("W"))
m2_p3 = data.frame(machine=c(2L), outcome=c("L"))
posteriors_m2_1 = bandit_posterior(m2_p1, prior=c(0.5, 0.5))
posteriors_m2_2 = bandit_posterior(m2_p2, prior=posteriors_m2_1)
posteriors_m2_3 = bandit_posterior(m2_p3, prior=posteriors_m2_2)
...
posteriors_m1_1 = bandit_posterior(m1_p1, prior=posteriors_m2_3)
posteriors_m1_2 = bandit_posterior(m1_p2, prior=posteriors_m1_1)
...
```{r}
data = data.frame(machine = c(1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L), outcome = c("L", "L", "L", "L", "W", "L", "W", "W", "W", "L", "L", "W", "L", "W", "L", "W", "L", "L", "L", "W", "L", "L", "L", "L", "L", "L", "W", "L", "W", "L", "L", "L", "L", "L", "L", "W", "W", "W", "L", "L", "W", "L", "L", "W", "W", "L", "L", "L", "W", "W"))
